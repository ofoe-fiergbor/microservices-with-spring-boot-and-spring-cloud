...
class MapperTests {
    ...
    void mapperTests() {
        ...
        RecommendationEntity entity = mapper.dtoToEntity(api);
        ...
        Recommendation api2 = mapper.entityToDto(entity);
    ...
    void mapperListTests() {
        ...
        List<RecommendationEntity> entityList = apiList.stream().map(a -> mapper.dtoToEntity(a)).toList();
        ...
        List<Recommendation> api2List = entityList.stream().map(e -> mapper.entityToDto(e)).toList();
